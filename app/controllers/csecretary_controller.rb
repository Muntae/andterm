class CsecretaryController < ApplicationController
  ...
  def updateview
    ...
    #har_c = har_c_doc.css("").to_a
    #tempname = "har_c"
    #@lecture1_0 = Parser.startParse 
    ...
    @lecture1_3 = Parser.startParse intel_cs_noti, tempname
    ...
    #데이터통신 공지(이정태)
    nwlab_data_noti_uri = URI("http://52.196.227.153:8080/parsingHelper/LogicalCircuit059.jsp")
    ...
    #데이터통신 강의(이정태)
    nwlab_data_lect_uri = URI("http://52.196.227.153:8080/parsingHelper/LogicalCircuit059.jsp")
    ...
    mobile_data_lec = mobile_data_lec_doc.css("td.title/a").to_a
